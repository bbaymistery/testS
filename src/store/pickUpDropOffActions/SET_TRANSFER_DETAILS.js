function SET_TRANSFER_DETAILS(params = {}) {
    ...
    let paymentDetails = newState.reservations[index].paymentDetails
    ...
    } else if (name === "accountReferanceNumber") {
        newState.reservations[index].paymentDetails = { ...paymentDetails, [name]: value }
    }
    return newState;
}
